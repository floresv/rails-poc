...
ActiveRecord::Schema[7.2].define(version: 2025_02_23_125933) do
  ...
  create_table "wishlists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["wishlistable_type", "wishlistable_id"], name: "index_wishlists_on_wishlistable"
    t.index ["wishlistable_type", "wishlistable_id"], name: "index_wishlists_wishlistable", unique: true
  end
